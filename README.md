...
Development requires Node.js 22.13.0 or newer and pnpm 11.20.0. The minimum Node.js version is required because the development and release commands execute `.mts` scripts directly using Node.js native TypeScript stripping; the scripts also use `import.meta.dirname`.
