...
Development requires Node.js 22.22.2 or newer and pnpm 11.20.0. This development pin supports the repository's direct `.mts` execution and satisfies pnpm 11's Node.js 22.13 minimum; the shipped extension's existing Node.js engine declaration remains unchanged.
