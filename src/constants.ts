...
export const COMMAND_IDS = {
  ...
  status: "arashi.status",
  move: "arashi.move",
  prune: "arashi.prune",
  setup: "arashi.setup",
  shell: "arashi.shell",
  update: "arashi.update",
  install: "arashi.install",
  ...
  panelOpenStatusRepo: "arashi.worktrees.openStatusRepo",
  panelOpenTerminal: "arashi.worktrees.openTerminal",
  panelPullRepo: "arashi.worktrees.pullRepo",
  panelCloneMissing: "arashi.worktrees.cloneMissing",
